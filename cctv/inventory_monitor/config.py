...
class DetectionConfig:
    ...
    # Auto-registration
    auto_register: bool = False  # Auto-register unknown faces
    auto_register_pattern: str = "Person_{}"  # Label pattern for auto-registered faces

    # Priority recognition
    priority_recognition: bool = True  # Prioritize face recognition near door

    # Deferred event resolution
    identity_resolve_timeout: float = 30.0  # Seconds before deferred event expires
    ...
    def save(self, path: str = "config.json"):
        ...
        data = {
            "detection": {
                ...
                "auto_register": self.detection.auto_register,
                "auto_register_pattern": self.detection.auto_register_pattern,
                "priority_recognition": self.detection.priority_recognition,
                "identity_resolve_timeout": self.detection.identity_resolve_timeout,
            },
            "tracking": {
            ...
            "training": {
                ...
                "capture_interval": self.training.capture_interval,
                "max_samples": self.training.max_samples,
                "auto_verify_threshold": self.training.auto_verify_threshold,
                "retrain_min_samples": self.training.retrain_min_samples,
            },
            "review": {
